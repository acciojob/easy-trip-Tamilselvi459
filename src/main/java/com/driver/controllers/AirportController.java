...
public class AirportController {
    ...
    @GetMapping("/get-largest-aiport") //2
    ...
    @GetMapping("/get-shortest-time-travel-between-cities") //3
    ...
    @GetMapping("/get-number-of-people-on-airport-on/{date}") //4
    public int getNumberOfPeopleOn(@PathVariable("date") Date date,@RequestParam("airportName")String airportName){
       ...
       // airportservice.getNumberOfPeople(date , airportName);
        return airportservice.getNumberOfPeopleOn(date , airportName);
    }

    @GetMapping("/calculate-fare") //5
    ...
    @GetMapping("/get-count-of-bookings-done-by-a-passenger/{passengerId}") //8
    ...
    @GetMapping("/get-aiportName-from-flight-takeoff/{flightId}") //10
    ...
    @GetMapping("/calculate-revenue-collected/{flightId}") //11
